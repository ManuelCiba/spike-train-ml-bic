...
TARGET_DATA_FOLDER = settings.FOLDER_NAME_measures
...
def calculate_complex_network_measures(chip_path):
    ...
    for file in file_list:
        ...
        # testing the case of empty matrices
        #G = Graph.Adjacency([])
        #u = Graph.community_leading_eigenvector(G)
        ...
        graph_list = []
        graph_list.append(G) # this graph list only contains one element.
        # a list is needed for the complex network measures function
